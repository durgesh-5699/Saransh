...
export function SummaryViewer({ summary }: { summary: string }) {
  ...
  return (
    <Card className="relative px-2 h-[500px] sm:h-[400px] lg:h-[600px] w-full xl:w-[600px] overflow-hidden bg-linear-to-br from-background via-background/95 to-rose-500/5 backdrop-blur-lg shadow-2xl rounded-3xl border border-rose-500/10">
