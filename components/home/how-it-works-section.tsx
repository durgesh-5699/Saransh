...
const steps: Step[] = [
  {
    ...
    label: "Upload youe PDF",
    description: "Simply drag and drop you PDF document or click to upload.",
  },
  {
    icon: <BrainCircuit size={64} strokeWidth={1.5} />,
    label: "AI Analysis",
    description:
      "Our advanced AI processes and anayzes your document instantly.",
  },
  {
...
export default function HowItWorksSection() {
  return (
    <section className="relative overflow-hidden bg-gray-50 border-red-600">
